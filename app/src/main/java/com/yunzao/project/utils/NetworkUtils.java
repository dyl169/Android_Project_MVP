...
public class NetworkUtils {
    ...
    private static String getProvider(Context context) {
        ...
        try {
            ...
            LogUtil.debug(TAG, "getProvider.IMSI:" + IMSI);
            if (IMSI == null) {
                if (TelephonyManager.SIM_STATE_READY == telephonyManager.getSimState()) {
                    String operator = telephonyManager.getSimOperator();
                    LogUtil.debug(TAG, "getProvider.operator:" + operator);
                    if (operator != null) {
    ...
    private static String getNetworkTypeNoProvider(Context context) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            if (networkInfo.getType() == ConnectivityManager.TYPE_WIFI) {
                ...
                LogUtil.debug(TAG, "Network getSubtypeName : " + _strSubTypeName);
                ...
                LogUtil.debug(TAG, "Network getSubtype : " + Integer.valueOf(networkType).toString());
            }
        }

        LogUtil.debug(TAG, "Network Type : " + strNetworkType);
