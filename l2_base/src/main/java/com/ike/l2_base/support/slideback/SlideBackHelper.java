...
import com.ike.l2_base.support.slideback.callback.OnInternalStateListener;
import com.ike.l2_base.support.slideback.callback.OnSlideListener;
...
public class SlideBackHelper {
     ...
     */
    public static SlideBackLayout attach(@NonNull final Activity curActivity,
                                         @NonNull final ActivityHelper helper,
                                         @Nullable final SlideConfig config,
        ...
        slideBackLayout = new SlideBackLayout(curActivity, contentView, preContentView[0], preDecorViewDrawable, config, new OnInternalStateListener() {
            ...
            public void onClose(Boolean finishActivity) {
                ...
                if (finishActivity != null && finishActivity) {
                    curActivity.finish();
                    curActivity.overridePendingTransition(0, R.anim.anim_base_activity_out_none);
